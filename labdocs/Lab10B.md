...
3. In the Jupyter home page, in the **Users/DP100_retail** folder, open the **10B - Monitoring Data Drift.ipynb** notebook. Then read the notes in the notebook, running each code cell in turn.
